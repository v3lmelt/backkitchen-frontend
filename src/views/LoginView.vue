  ...
  <div class="relative flex h-screen w-screen items-center justify-center bg-background overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-[400px] px-6 animate-fade-in">
      ...
      <div class="bg-card border border-border rounded-none p-8">
        <h1 class="font-mono text-xl font-bold text-foreground mb-7">{{ t('auth.login.title') }}</h1>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5">
          ...
          <div class="flex items-center justify-between">
            ...
            <RouterLink to="/forgot-password" class="text-sm text-primary hover:text-primary-hover font-sans transition-colors">{{ t('auth.login.forgotPassword') }}</RouterLink>
          </div>
