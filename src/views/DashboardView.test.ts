...
describe('DashboardView', () => {
  beforeEach(() => {
    ...
    mocks.albumExportStreamMock.mockImplementation((_albumId: number, onEvent: (event: any) => void) => {
      void Promise.resolve().then(() => onEvent({ type: 'complete', download_id: 'download-1', total: 2, processed: 2 }))
      return { cancel: vi.fn() }
    })
