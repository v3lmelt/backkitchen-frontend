...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    "headline": {
      "zh-CN": "专辑范围筛选与曲目灵活评审",
      "en": "Album scopes and flexible track reviews"
    },
    "summary": {
      "zh-CN": "按参与关系筛选专辑，在曲目详情调整进度，并为单曲管理灵活评审名单。",
      "en": "Filter albums by participation, adjust progress from track details, and manage flexible review rosters per track."
    },
    "sections": [
      {
        "heading": {
