...
曲师完成提交后，曲目会返回“母带制作”。此时应检查新的源版本或外部链接，再继续母带工作。
...
2. 检查文件是否完整、可播放且版本正确。
3. 核对交付说明。
4. 在阶段页点击“确认交付”；旧母带工作台中该按钮可能显示为“确认上传无误”。
...
当前界面并未将母带工程师的目标严格限制为母带阶段。选择同行修订、主催修订等更早阶段前，应先与主催确认。重新开启会清除当前母带的主催和投稿侧批准状态，需要重新完成交付或终审。返回首个交付阶段或更早阶段会增加制作周期；返回晚于首个交付阶段的阶段不会增加周期。
...
请检查是否还需要点击“确认交付”（旧母带工作台中可能显示为“确认上传无误”）。默认工作流要求上传者确认后才推进。
