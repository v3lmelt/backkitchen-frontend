...
创建成功后，创建者自动成为该社团的主催，并可以管理成员、邀请码和社团内专辑。
...
加入成功后，用户会出现在社团成员列表中。加入社团不会自动分配专辑或曲目任务。
...
只有社团主催可以调整成员身份。副主催可以协助管理社团和专辑，但不能代替社团主催修改成员身份。
...
创建或编辑专辑时，还需要在专辑团队设置中明确选择该专辑的母带工程师。
...
加入社团不会自动加入已有专辑。请由专辑主催将成员添加到制作团队，或为其分配曲目职责。
