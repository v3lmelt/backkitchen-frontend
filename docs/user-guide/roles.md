...
| 主催 | 注册后由平台管理员开通 | 创建社团，并管理自己有权限的专辑 |

账户主催身份只表示用户可以创建社团。它不会自动授予其他社团或专辑的管理权限。
...
只有社团主催可以调整成员身份和设置副主催。成员通过不同类型的邀请码加入后，主催仍可在社团成员设置中调整其身份。
...
社团中的“母带工程师”身份不会自动将用户分配到所有专辑。只有在专辑设置中被指定后，用户才能执行该专辑的母带操作。
