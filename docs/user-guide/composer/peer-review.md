...
如果主催为当前曲目阶段启用了“灵活评审”，所需人数就是当前名单人数。提交个人意见后等待其他评审人完成；全员完成后，任何仍在名单中的评审人要求修改都会使曲目退回，否则自动通过。无需另行提交评审组最终结论，也不会因为一人要求修改就提前结束。

主催可调整名单。被移除后的历史意见仍保留，但不计入本次结果；重新加入或进入返修后的新一轮时，需要重新提交评审。未启用灵活模式的曲目仍按前述专辑规则执行。
